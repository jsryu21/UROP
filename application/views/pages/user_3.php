<div class="container">
	...
	<div class="user_comments">
		...
		<div class="user_comments_more"><a href="/index.php/detail/<?=$url_facebook_id?>" class="btn btn-primary">더 자세히 보기</a></div>
	</div>
</div>
<div class="footer">
	<div class="container">
		<div class="user_invitation_ment">
			<h4>당신만의 매력과 단점은 무엇인가요? 친구들을 checkee로 초대해 체크 받아 보세요.</h4>
		</div>
